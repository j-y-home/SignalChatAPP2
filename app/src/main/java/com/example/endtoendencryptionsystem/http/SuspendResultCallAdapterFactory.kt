...
/**
 * A [CallAdapter.Factory] which wraps the response in a [Result] type.
 *
 * [引用](https://github.com/yujinyan/retrofit-suspend-result-adapter)
 *
 * [原文](https://blog.yujinyan.me/posts/kotlin-coroutine-retrofit/#)
 */
